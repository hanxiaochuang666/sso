...
public class UserApi {
    ...
    public BaseModle queryUserInfo(@RequestBody User user) throws Exception{
    ...
    public Map checkToken(@ApiParam(value = "token", required = true) @PathVariable("token") String token) throws Exception{
    ...
    public String uploadFile(@RequestParam("file") MultipartFile file, @RequestParam("userId") int userId) throws Exception{

        // 获取文件名
        String fileName = file.getOriginalFilename();
        fileName = DateTimeFormatter.ofPattern("yyyyMMddHHmmss").format(LocalDateTime.now()) + "_"
                + fileName;
